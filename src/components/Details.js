            ...
            <div className='row'>
                ...
                <div className='col-6'>
                    ...
                    <div className='details__prices'>
                        <span className='details__actaul'>{currencyFormatter.format(product.price, { code: 
                        'USD' })}</span>
                    ...
                    <div className='details__info'>
                        <div className='details__incDnc'>
                            ...
                            <button className='btn btn-cart' onClick={() => dispatch({type: 'ADD_TO_CART', payload: {product, quantity}})}>add to cart</button>
                        </div>
